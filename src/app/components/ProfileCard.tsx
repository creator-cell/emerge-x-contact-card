    ...
    <div className="flex w-full relative bg-white h-screen max-h-screen overflow-y-auto overflow-x-hidden justify-center items-center p-4">
      <div className="max-w-4xl relative z-10 w-full rounded-xl bg-[#080a08] shadow-2xl p-2 md:p-6 md:pt-0 m-auto">
        <Image
          src={logo}
          alt="Logo"
          className="absolute w-28 md:w-44 top-2 z-20 max-md:left-1/2 max-md:-translate-x-1/2 md:right-4"
        />
          ...
          <div className="flex flex-col md:flex-row overflow-hidden md:pt-6 justify-between">
            ...
            bg-[linear-gradient(to_right,rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.03)_1px,transparent_1px)]
              ...
              <div className="space-y-2 text-center md:text-left relative z-20">
                <h1 className="text-2xl lg:text-3xl font-[900] text-white">
                  {data?.name}
                </h1>
                <p className="text-md font-[400] text-white">
                  {data?.position}
                </p>
              </div>
